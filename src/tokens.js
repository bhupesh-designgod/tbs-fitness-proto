...
export const T = {
  ...
  // MEAL / calorie family → punchy energy orange (data)
  meal: '#FF7A1A',
  mealTint: 'rgba(255,122,26,0.14)',
  ...
  // Quartet reads as one family: orange (cal) · jade (P) · rose (F) · violet (C).
  cal: '#FF7A1A',               // calories → punchy energy orange (the hero ring)
  calTint: 'rgba(255,122,26,0.14)',
